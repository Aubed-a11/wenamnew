...
export default function GalleryPage() {
  ...
  const [form, setForm] = useState({ image: '', category: 'aecam' })
  ...
  const add = async () => {
    ...
    try {
      if (method === 'file') {
        ...
        fd.append('title', file.name.replace(/\.[^/.]+$/, '') || 'Photo')
        ...
        await api.post('/gallery', { image: form.image, category: form.category, title: 'Photo' })
      }
